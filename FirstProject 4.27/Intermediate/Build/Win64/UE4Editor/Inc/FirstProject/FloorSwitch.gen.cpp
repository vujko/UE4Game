...
// End Cross Module References
	DEFINE_FUNCTION(AFloorSwitch::execHandlePlayerGettingOffSwitch)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->HandlePlayerGettingOffSwitch();
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(AFloorSwitch::execUpdateSwitchElevation)
	{
		P_GET_PROPERTY(FFloatProperty,Z_Param_Z);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->UpdateSwitchElevation(Z_Param_Z);
		P_NATIVE_END;
	}
	DEFINE_FUNCTION(AFloorSwitch::execUpdateDoorElevation)
	{
		P_GET_PROPERTY(FFloatProperty,Z_Param_Z);
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->UpdateDoorElevation(Z_Param_Z);
		P_NATIVE_END;
	}
	...
	void AFloorSwitch::StaticRegisterNativesAFloorSwitch()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "HandlePlayerGettingOffSwitch", &AFloorSwitch::execHandlePlayerGettingOffSwitch },
			{ "OnOverlapBegin", &AFloorSwitch::execOnOverlapBegin },
			{ "OnOverlapEnd", &AFloorSwitch::execOnOverlapEnd },
			{ "UpdateDoorElevation", &AFloorSwitch::execUpdateDoorElevation },
			{ "UpdateSwitchElevation", &AFloorSwitch::execUpdateSwitchElevation },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_AFloorSwitch_HandlePlayerGettingOffSwitch_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFloorSwitch_HandlePlayerGettingOffSwitch_Statics::Function_MetaDataParams[] = {
		{ "Category", "FloorSwitch" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFloorSwitch_HandlePlayerGettingOffSwitch_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFloorSwitch, nullptr, "HandlePlayerGettingOffSwitch", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFloorSwitch_HandlePlayerGettingOffSwitch_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AFloorSwitch_HandlePlayerGettingOffSwitch_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AFloorSwitch_HandlePlayerGettingOffSwitch()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFloorSwitch_HandlePlayerGettingOffSwitch_Statics::FuncParams);
		}
	...
	struct Z_Construct_UFunction_AFloorSwitch_UpdateDoorElevation_Statics
	{
		struct FloorSwitch_eventUpdateDoorElevation_Parms
		{
			float Z;
		};
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AFloorSwitch_UpdateDoorElevation_Statics::NewProp_Z = { "Z", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FloorSwitch_eventUpdateDoorElevation_Parms, Z), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFloorSwitch_UpdateDoorElevation_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFloorSwitch_UpdateDoorElevation_Statics::NewProp_Z,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFloorSwitch_UpdateDoorElevation_Statics::Function_MetaDataParams[] = {
		{ "Category", "FloorSwitch" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFloorSwitch_UpdateDoorElevation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFloorSwitch, nullptr, "UpdateDoorElevation", nullptr, nullptr, sizeof(FloorSwitch_eventUpdateDoorElevation_Parms), Z_Construct_UFunction_AFloorSwitch_UpdateDoorElevation_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AFloorSwitch_UpdateDoorElevation_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFloorSwitch_UpdateDoorElevation_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AFloorSwitch_UpdateDoorElevation_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AFloorSwitch_UpdateDoorElevation()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFloorSwitch_UpdateDoorElevation_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	struct Z_Construct_UFunction_AFloorSwitch_UpdateSwitchElevation_Statics
	{
		struct FloorSwitch_eventUpdateSwitchElevation_Parms
		{
			float Z;
		};
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_Z;
	...
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_AFloorSwitch_UpdateSwitchElevation_Statics::NewProp_Z = { "Z", nullptr, (EPropertyFlags)0x0010000000000080, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(FloorSwitch_eventUpdateSwitchElevation_Parms, Z), METADATA_PARAMS(nullptr, 0) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_AFloorSwitch_UpdateSwitchElevation_Statics::PropPointers[] = {
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_AFloorSwitch_UpdateSwitchElevation_Statics::NewProp_Z,
	};
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AFloorSwitch_UpdateSwitchElevation_Statics::Function_MetaDataParams[] = {
		{ "Category", "FloorSwitch" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
	};
#endif
	const UE4CodeGen_Private::FFunctionParams Z_Construct_UFunction_AFloorSwitch_UpdateSwitchElevation_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_AFloorSwitch, nullptr, "UpdateSwitchElevation", nullptr, nullptr, sizeof(FloorSwitch_eventUpdateSwitchElevation_Parms), Z_Construct_UFunction_AFloorSwitch_UpdateSwitchElevation_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_AFloorSwitch_UpdateSwitchElevation_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_AFloorSwitch_UpdateSwitchElevation_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_AFloorSwitch_UpdateSwitchElevation_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_AFloorSwitch_UpdateSwitchElevation()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UE4CodeGen_Private::ConstructUFunction(ReturnFunction, Z_Construct_UFunction_AFloorSwitch_UpdateSwitchElevation_Statics::FuncParams);
		}
		return ReturnFunction;
	}
...
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_TimeDelay;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AFloorSwitch_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AFloorSwitch_HandlePlayerGettingOffSwitch, "HandlePlayerGettingOffSwitch" }, // 3083740279
		{ &Z_Construct_UFunction_AFloorSwitch_LowerDoor, "LowerDoor" }, // 2954791531
		{ &Z_Construct_UFunction_AFloorSwitch_LowerFloorSwitch, "LowerFloorSwitch" }, // 1530339104
		...
		{ &Z_Construct_UFunction_AFloorSwitch_RaiseDoor, "RaiseDoor" }, // 4157664684
		{ &Z_Construct_UFunction_AFloorSwitch_RaiseFloorSwitch, "RaiseFloorSwitch" }, // 789893891
		{ &Z_Construct_UFunction_AFloorSwitch_UpdateDoorElevation, "UpdateDoorElevation" }, // 1648083061
		{ &Z_Construct_UFunction_AFloorSwitch_UpdateSwitchElevation, "UpdateSwitchElevation" }, // 1187867928
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloorSwitch_Statics::NewProp_TimeDelay_MetaData[] = {
		{ "Category", "FloorSwitch" },
		{ "ModuleRelativePath", "FloorSwitch.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFloorSwitch_Statics::NewProp_TimeDelay = { "TimeDelay", nullptr, (EPropertyFlags)0x0010000000000004, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFloorSwitch, TimeDelay), METADATA_PARAMS(Z_Construct_UClass_AFloorSwitch_Statics::NewProp_TimeDelay_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFloorSwitch_Statics::NewProp_TimeDelay_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFloorSwitch_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFloorSwitch_Statics::NewProp_TimeDelay,
	};
	...
	IMPLEMENT_CLASS(AFloorSwitch, 3302692808);
