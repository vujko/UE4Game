...
// End Cross Module References
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_InterpTimer_MetaData[];
#endif
		static const UE4CodeGen_Private::FFloatPropertyParams NewProp_InterpTimer;
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpTimer_MetaData[] = {
		{ "Category", "Platform" },
		{ "ModuleRelativePath", "FloatingPlatform.h" },
	};
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpTimer = { "InterpTimer", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFloatingPlatform, InterpTimer), METADATA_PARAMS(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpTimer_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpTimer_MetaData)) };
#if WITH_METADATA
...
#endif
	const UE4CodeGen_Private::FFloatPropertyParams Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_Distance = { "Distance", nullptr, (EPropertyFlags)0x0010000000000015, UE4CodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AFloatingPlatform, Distance), METADATA_PARAMS(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_Distance_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_Distance_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AFloatingPlatform_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AFloatingPlatform_Statics::NewProp_InterpTimer,
	...
	IMPLEMENT_CLASS(AFloatingPlatform, 75962001);
